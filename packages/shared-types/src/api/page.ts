...
export const PageListItemSchema = z.object({
  ...
  contentType: z.enum(["MARKDOWN", "HTML", "MDX", "BLOCK"]),
  createdAt: z.string(),
  updatedAt: z.string(),
  author: z.object({
...
export const UpdatePagesSchema = z.object({
  ...
  contentType: z.enum(["MARKDOWN", "HTML", "MDX", "BLOCK"]).optional(),
...
export const CreatePageSchema = z.object({
  ...
  content: z.string().optional(),
  contentType: z.enum(["MARKDOWN", "HTML", "MDX", "BLOCK"]).default("MARKDOWN"),
  config: z.any().optional(),
