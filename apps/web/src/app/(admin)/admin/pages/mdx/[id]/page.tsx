...
export async function generateMetadata(props: Props) {
  ...
  return generateSeoMetadata(
    {
      title: `管理面板/页面管理/MDX编辑器/${id}`,
      description: `编辑页面内容（MDX）：${id}`,
    },
    {
      pathname: `/admin/pages/mdx/${id}`,
    },
  );
}

export default async function MdxPageEditorPage({ params }: Props) {
